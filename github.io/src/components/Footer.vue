<template>
  <div>
    ...
    <div class="footer-context-left">
      ...
      <ul style="list-style-type: none; margin-top: 30px;">
        <li style="display: inline-block; margin-right: 30px; margin-bottom: 15px;">
          <a class="footer-link list-item" href="https://github.com/amirhnajafiz">
        ...
        <li style="display: inline-block; margin-right: 30px; margin-bottom: 15px;">
          <a class="footer-link list-item" href="https://medium.com/@amirhossein-najafizadeh">
        ...
        <li style="display: inline-block; margin-right: 30px; margin-bottom: 15px;">
          <a class="footer-link list-item" href="https://www.linkedin.com/in/amirnhnajafiz21/">
        ...
        <li style="display: inline-block; margin-right: 30px; margin-bottom: 15px;">
          <a class="footer-link list-item" href="https://stackoverflow.com/users/15769399/amirh-najafizadeh">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-stack-overflow" viewBox="0 0 16 16">
        ...
        <li style="display: inline-block; margin-right: 30px; margin-bottom: 15px;">
          <a class="footer-link list-item" href="https://www.researchgate.net/profile/Amirhossein-Najafizadeh">
